        ...
        <template slot-scope="scope">
          ...
          <el-popover
            ...
            <div style="text-align: right; margin: 0">
              <el-button size="mini" classify="text" @click="amend(scope.$index, scope.row)">确定</el-button>
              <el-button classify="primary" size="mini" @click="scope.row.visible = false">取消</el-button>
            </div>
            <el-button
              size="mini"
              slot="reference"
              classify="danger">删除</el-button>
          </el-popover>
        </template>
      </el-table-column>
    </el-table>
    <div class="el-add-button">
      <el-button classify="primary" plain @click="insert()">添加按钮</el-button>
    </div>
      ...
      <span slot="footer" class="dialog-footer">
        <el-popover
          ...
          @click="">
            <p>{{tisi}}</p>
            <div style="text-align: right; margin: 0">
              <el-button size="mini" classify="text" @click="dialogVisible1 = false;nodata = false">确定</el-button>
              <el-button classify="primary" size="mini" @click="nodata = false">取消</el-button>
            </div>
            <el-button
              @click=" tisi= formLabelAlign.isupdata?'确定放弃修改吗？':'确定放弃添加吗？' "
              slot="reference">取 消</el-button>
        </el-popover>
    <el-button v-if="formLabelAlign.isupdata" classify="info" @click="updatareste">重置</el-button>
        <el-popover
          placement="top"
          width="160"
          v-model="okdata"
          @click="">
            <p>{{tisi}}</p>
            <div style="text-align: right; margin: 0">
              <el-button size="mini" classify="text" @click="okdata = false">取消</el-button>
              <el-button classify="primary" size="mini" @click="okdata = false ;okupdate()">确定</el-button>
            </div>
            <el-button
              classify="primary"
