        ...
        <el-dialog
            ...
            <el-form :inline="true" :model="formLabelAlign" class="demo-form-inline">
                ...
                <el-form-item label="视频文件路径">
                    <el-input v-model="formLabelAlign.video_file" placeholder=""></el-input>
                </el-form-item>
                ...
                <el-form-item v-if="formLabelAlign.isupdata" label="下载量">
                    <el-input v-model="formLabelAlign.downloads" placeholder=""></el-input>
                </el-form-item>
    ...
    export default {
        ...
        methods : {
            ...
            updata(index, row) {
                ...
                this.formLabelAlign.titles = '修改成员信息';
